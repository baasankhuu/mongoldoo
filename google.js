    ...
    $.joextension.widget("sociallocker_facebook_share", {
        ...
        */
        _createButton: function () {
            ...
            this.button.append($("<a href='#' class='jo-facebook-share-icon'></a>"));
            this.button.append($("<div class='jo-facebook-share-count'>" + count + "</div>"));
            this.button.data('facebook-widget', this);
        ...
        getCountLabel: function(count) {
            if ( count >= 10 ) return Math.floor( count / 1000 ) + "K";
            return count;
        },
    ...
    $.joextension.widget("sociallocker", {
        ...
        */
        _processOptions: function () {
            ...
            if (options.buttons.layout == "horizontal") {
                options.facebook.layout = "button";
        ...
        */
        _createMarkup: function () {
            ...
            var resultText = $("<div class='jo-sociallocker-text'></div>");
